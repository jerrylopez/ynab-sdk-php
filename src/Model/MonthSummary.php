...
class MonthSummary implements ModelInterface, ArrayAccess
{
     ...
     * Sets income
     *
     * @param int $income The total amount of transactions categorized to 'Inflow: To be Budgeted' in the month
     *
     * @return $this
     */
     ...
     * Sets activity
     *
     * @param int $activity The total amount of transactions in the month, excluding those categorized to 'Inflow: To be Budgeted'
     *
     * @return $this
     */
