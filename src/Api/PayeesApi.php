...
class PayeesApi
{
     ...
     */
    public function getPayees($budget_id)
    {
        list($response) = $this->getPayeesWithHttpInfo($budget_id);
        return $response;
    }
     ...
     */
    public function getPayeesWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\PayeesResponse';
        $request = $this->getPayeesRequest($budget_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayeesAsync($budget_id)
    {
        return $this->getPayeesAsyncWithHttpInfo($budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayeesAsyncWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\PayeesResponse';
        $request = $this->getPayeesRequest($budget_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayeesRequest($budget_id)
    {
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
