...
class CategoriesApi
{
    ...
    {
        list($response) = $this->getCategoriesWithHttpInfo($budget_id);
        return $response;
    }
     ...
     */
    public function getCategoriesWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\CategoriesResponse';
        $request = $this->getCategoriesRequest($budget_id);
     ...
     */
    public function getCategoriesAsync($budget_id)
    {
        return $this->getCategoriesAsyncWithHttpInfo($budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoriesAsyncWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\CategoriesResponse';
        $request = $this->getCategoriesRequest($budget_id);
     ...
     */
    protected function getCategoriesRequest($budget_id)
    {
