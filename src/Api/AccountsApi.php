...
class AccountsApi
{
     ...
     */
    public function getAccounts($budget_id)
    {
        list($response) = $this->getAccountsWithHttpInfo($budget_id);
        return $response;
    }
     ...
     */
    public function getAccountsWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\AccountsResponse';
        $request = $this->getAccountsRequest($budget_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountsAsync($budget_id)
    {
        return $this->getAccountsAsyncWithHttpInfo($budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountsAsyncWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\AccountsResponse';
        $request = $this->getAccountsRequest($budget_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountsRequest($budget_id)
    {
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
