...
class MonthsApi
{
     ...
     */
    public function getBudgetMonths($budget_id)
    {
        list($response) = $this->getBudgetMonthsWithHttpInfo($budget_id);
        return $response;
    }
     ...
     */
    public function getBudgetMonthsWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\MonthSummariesResponse';
        $request = $this->getBudgetMonthsRequest($budget_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBudgetMonthsAsync($budget_id)
    {
        return $this->getBudgetMonthsAsyncWithHttpInfo($budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBudgetMonthsAsyncWithHttpInfo($budget_id)
    {
        $returnType = '\Ynab\Model\MonthSummariesResponse';
        $request = $this->getBudgetMonthsRequest($budget_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBudgetMonthsRequest($budget_id)
    {
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
