...
> \Ynab\Model\TransactionsResponse getTransactionsByAccount($budget_id, $account_id, $since_date)
...
try {
    $result = $apiInstance->getTransactionsByAccount($budget_id, $account_id, $since_date);
    print_r($result);
} catch (Exception $e) {
...
> \Ynab\Model\TransactionsResponse getTransactionsByCategory($budget_id, $category_id, $since_date)
...
try {
    $result = $apiInstance->getTransactionsByCategory($budget_id, $category_id, $since_date);
    print_r($result);
} catch (Exception $e) {
